        ...
        for (TextView view : views) {
            if (view != null) {
                ...
                if (view != mWeatherTemp || view != mWeatherTempSub) {
                    ...
                    if (bgDrawable != 0) {
                        mWeatherIcon.setPadding((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, getContext().getResources().getDimensionPixelSize(R.dimen.quickspace_no_divider_padding), getContext().getResources().getDisplayMetrics()),0,0,0);
                    }
                }
