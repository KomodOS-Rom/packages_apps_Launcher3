...
public class LauncherAppState {
    ...
    private LauncherAppState(Context context) {
        ...
        setSearchAppAvailable(KomodoUtils.isPackageInstalled(context, LauncherTab.SEARCH_PACKAGE));
        setCalendarAppAvailable(KomodoUtils.isPackageInstalled(context, "com.google.android.calendar"));
